...
const page = () => {
      ...
      return (
        <li key={i}>
          <div className="flex align-middle justify-evenly my-5">
            ...
            <button onClick={ () => {
              deleteHandler(i)
            }} className="rounded font-semibold bg-red-700 text-white w-1/12">Delete</button>
          </div>
        </li>
      );
    });
  ...
  return (
    <>
      ...
      <form onSubmit={submitHandler} className="flex flex-col m-auto items-center py-3 w-full ">
        <input
